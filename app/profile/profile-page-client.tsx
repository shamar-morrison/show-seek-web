    ...
    return (
      <>
        ...
        <div className="rounded-2xl bg-white/5 ring-1 ring-white/8">
          ...
          <div className="mx-4 border-t border-white/10" />
          <PreferenceToggle
            label="Hide talk shows & award shows"
            description="Hide late-night, daytime talk, news talk and award ceremonies from browsing"
            checked={preferences.hideTalkShowsAndAwards}
            onChange={(value) =>
              updatePreference("hideTalkShowsAndAwards", value)
            }
            isPremium={canAccessPremiumFeatures}
          />
          <div className="mx-4 border-t border-white/10" />
