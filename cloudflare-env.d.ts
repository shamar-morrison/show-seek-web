/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config .wrangler/wrangler.local.jsonc --strict-vars false --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 110db46cba478f9aaff93c8dbf1aa567)
